...
let write_errorOutput = (
  Atdgen_codec_runtime.Encode.make (fun (t : errorOutput) ->
    (
    Atdgen_codec_runtime.Encode.obj
      [
          Atdgen_codec_runtime.Encode.field
    ...
    (
      ({
          status_code =
            ...
            (
              Atdgen_codec_runtime.Decode.int
              |> Atdgen_codec_runtime.Decode.field "status_code"
            ) json;
          error_description =
            Atdgen_codec_runtime.Decode.decode
            (
              Atdgen_codec_runtime.Decode.string
              |> Atdgen_codec_runtime.Decode.field "error_description"
            ) json;
          error =
            Atdgen_codec_runtime.Decode.decode
            (
              Atdgen_codec_runtime.Decode.string
              |> Atdgen_codec_runtime.Decode.field "error"
            ) json;
      } : errorOutput)
    )
  )
