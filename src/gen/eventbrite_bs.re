...
let write_address =
  Atdgen_codec_runtime.Encode.make((t: address) =>
    Atdgen_codec_runtime.Encode.obj([
      ...
      Atdgen_codec_runtime.Encode.field(write__4, ~name="city", t.city),
      Atdgen_codec_runtime.Encode.field(write__4, ~name="region", t.region),
      Atdgen_codec_runtime.Encode.field(
        write__4,
        ~name="postal_code",
        t.postal_code,
    ...
    (
      {
        ...
        address_2:
          Atdgen_codec_runtime.Decode.decode(
            read__4 |> Atdgen_codec_runtime.Decode.field("address_2"),
            json,
          ),
        city:
          Atdgen_codec_runtime.Decode.decode(
            read__4 |> Atdgen_codec_runtime.Decode.field("city"),
            json,
          ),
        region:
          Atdgen_codec_runtime.Decode.decode(
            read__4 |> Atdgen_codec_runtime.Decode.field("region"),
            json,
          ),
        postal_code:
          Atdgen_codec_runtime.Decode.decode(
            read__4 |> Atdgen_codec_runtime.Decode.field("postal_code"),
            json,
          ),
      }: address
    )
...
let write_venue =
  Atdgen_codec_runtime.Encode.make((t: venue) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(write__3, ~name="id", t.id),
      Atdgen_codec_runtime.Encode.field(write__4, ~name="name", t.name),
      Atdgen_codec_runtime.Encode.field(
        write_address,
        ~name="address",
        t.address,
    ...
    (
      {
        id:
          Atdgen_codec_runtime.Decode.decode(
            read__3 |> Atdgen_codec_runtime.Decode.field("id"),
            json,
          ),
        name:
          Atdgen_codec_runtime.Decode.decode(
            read__4 |> Atdgen_codec_runtime.Decode.field("name"),
            json,
          ),
        address:
          Atdgen_codec_runtime.Decode.decode(
...
let write_textHtmlNullable =
  Atdgen_codec_runtime.Encode.make((t: textHtmlNullable) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(write__4, ~name="text", t.text),
      Atdgen_codec_runtime.Encode.field(write__4, ~name="html", t.html),
    ])
  );
    ...
    (
      {
        text:
          Atdgen_codec_runtime.Decode.decode(
            read__4 |> Atdgen_codec_runtime.Decode.field("text"),
            json,
          ),
        html:
          Atdgen_codec_runtime.Decode.decode(
            read__4 |> Atdgen_codec_runtime.Decode.field("html"),
            json,
          ),
      }: textHtmlNullable
    )
...
let write_textHtml =
  Atdgen_codec_runtime.Encode.make((t: textHtml) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(
        Atdgen_codec_runtime.Encode.string,
        ~name="text",
...
let write_pagination =
  Atdgen_codec_runtime.Encode.make((t: pagination) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(
...
let write_organizer =
  Atdgen_codec_runtime.Encode.make((t: organizer) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(write__5, ~name="id", t.id),
      Atdgen_codec_runtime.Encode.field(write__4, ~name="name", t.name),
      Atdgen_codec_runtime.Encode.field(
    ...
    (
      {
        id:
          Atdgen_codec_runtime.Decode.decode(
            read__5 |> Atdgen_codec_runtime.Decode.field("id"),
            json,
          ),
        name:
          Atdgen_codec_runtime.Decode.decode(
...
let write_datetime =
  Atdgen_codec_runtime.Encode.make((t: datetime) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(
        Atdgen_codec_runtime.Encode.string,
        ~name="timezone",
      ...
      Atdgen_codec_runtime.Encode.field(write__6, ~name="utc", t.utc),
    ])
  );
let read_datetime =
  Atdgen_codec_runtime.Decode.make((json) =>
    (
      {
        ...
        utc:
          Atdgen_codec_runtime.Decode.decode(
            read__6 |> Atdgen_codec_runtime.Decode.field("utc"),
            json,
          ),
      }: datetime
    )
...
let write_event =
  Atdgen_codec_runtime.Encode.make((t: event) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(write__2, ~name="id", t.id),
      Atdgen_codec_runtime.Encode.field(write_textHtml, ~name="name", t.name),
      Atdgen_codec_runtime.Encode.field(
        write_textHtml,
        ~name="description",
        t.description,
      ...
      Atdgen_codec_runtime.Encode.field(write_datetime, ~name="end", t.end_),
      Atdgen_codec_runtime.Encode.field(
        Atdgen_codec_runtime.Encode.bool,
        ~name="is_series",
        t.is_series,
    ...
    (
      {
        id:
          Atdgen_codec_runtime.Decode.decode(
            read__2 |> Atdgen_codec_runtime.Decode.field("id"),
            json,
          ),
        name:
          Atdgen_codec_runtime.Decode.decode(
            read_textHtml |> Atdgen_codec_runtime.Decode.field("name"),
            json,
          ),
        description:
          Atdgen_codec_runtime.Decode.decode(
            read_textHtml |> Atdgen_codec_runtime.Decode.field("description"),
            json,
          ),
        url:
          Atdgen_codec_runtime.Decode.decode(
        ...
        end_:
          Atdgen_codec_runtime.Decode.decode(
            read_datetime |> Atdgen_codec_runtime.Decode.field("end"),
            json,
          ),
        is_series:
          Atdgen_codec_runtime.Decode.decode(
...
let write__1 = Atdgen_codec_runtime.Encode.list(write_event);
let read__1 = Atdgen_codec_runtime.Decode.list(read_event);
let write_events = write__1;
let read_events = read__1;
let write_searchOutput =
  Atdgen_codec_runtime.Encode.make((t: searchOutput) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(
        write_pagination,
        ~name="pagination",
    ...
    (
      {
        pagination:
          Atdgen_codec_runtime.Decode.decode(
            read_pagination |> Atdgen_codec_runtime.Decode.field("pagination"),
            json,
          ),
        events:
          Atdgen_codec_runtime.Decode.decode(
            read_events |> Atdgen_codec_runtime.Decode.field("events"),
            json,
          ),
      }: searchOutput
    )
...
let write_searchInput =
  Atdgen_codec_runtime.Encode.make((t: searchInput) =>
    Atdgen_codec_runtime.Encode.obj([
      Atdgen_codec_runtime.Encode.field(
